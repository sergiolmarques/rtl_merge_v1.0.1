...
#SLM
#ipx::add_memory_map m_axi_gmem $core
#ipx::add_address_block m_axi_gmem_ab [ipx::get_memory_maps m_axi_gmem -of_objects $core]
#set_property range 4294967296 [ipx::get_address_blocks m_axi_gmem_ab \
#    -of_objects [ipx::get_memory_maps m_axi_gmem -of_objects $core]]

ipx::add_memory_map m_axi_gmem1 $core
ipx::add_address_block m_axi_gmem1_ab [ipx::get_memory_maps m_axi_gmem1 -of_objects $core]
set_property range 4294967296 [ipx::get_address_blocks m_axi_gmem1_ab \
    -of_objects [ipx::get_memory_maps m_axi_gmem1 -of_objects $core]]
#set mem_map1    [::ipx::add_memory_map -quiet "m_axi_gmem1" $core]
#set addr_block1 [::ipx::add_address_block -quiet "reg1" $mem_map1]
#set reg1      [::ipx::add_register "HBM0" $addr_block1]
#  set_property address_offset 0x000 $reg1
#  set_property size           [expr {8*8}]   $reg1
#  set regparam1 [::ipx::add_register_parameter -quiet {ASSOCIATED_BUSIF} $reg1]
#  set_property value m_axi_hbm $regparam1
#SLM
...
set reg      [::ipx::add_register -quiet "length_r1" $addr_block]
